...
export default function AddStaffForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
      ...
      {success && <div className="bg-green-50 text-green-700 text-sm p-2 rounded mb-4"><BilingualText fr="{fullName} peut maintenant se connecter avec {email}." en="The staff member can now log in with the provided email." /></div>}
