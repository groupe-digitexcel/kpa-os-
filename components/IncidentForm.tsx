...
export default function IncidentForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
      <h2 className="font-semibold text-kpa-navy text-sm mb-4">Report an Incident</h2>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          <label className="block text-sm font-medium text-kpa-navy mb-1">Severity</label>
          <select
            value={severity}
      ...
      <label className="block text-sm font-medium text-kpa-navy mb-1">What happened?</label>
      <textarea
        value={description}
      ...
      <label className="block text-sm font-medium text-kpa-navy mb-1">Action Taken</label>
      <textarea
        value={actionTaken}
