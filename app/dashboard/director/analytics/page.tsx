...
export default async function AnalyticsPage() {
  ...
  return (
    <DashboardShell>
      <h1 className="text-2xl font-bold text-kpa-navy mb-1">Analytics</h1>
      <p className="text-sm text-gray-500 mb-6">Last 30 days</p>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <p className="text-xs text-gray-500 uppercase">Collected (30 days)</p>
          <p className="text-2xl font-bold text-kpa-navy mt-1">{totalCollected30d.toLocaleString()} XAF</p>
        </div>
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <p className="text-xs text-gray-500 uppercase">Avg. Daily Attendance</p>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <h2 className="font-semibold text-kpa-navy text-sm mb-2">Daily Collections</h2>
          <PaymentTrendChart data={payments} />
        </div>

        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <h2 className="font-semibold text-kpa-navy text-sm mb-2">Attendance Rate</h2>
          <AttendanceTrendChart data={attendance} />
        </div>

        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <h2 className="font-semibold text-kpa-navy text-sm mb-2">Enrollment by Class</h2>
