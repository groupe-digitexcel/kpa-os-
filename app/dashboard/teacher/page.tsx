  ...
  return (
    <DashboardShell>
      <h1 className="text-2xl font-bold text-kpa-navy mb-1">
        {(myClass as any)?.name ?? "My Class"}
      </h1>
      <p className="text-sm text-gray-500 mb-4">{students.length} students enrolled</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 divide-y">
        ...
        {students.length === 0 && (
          <p className="p-5 text-sm text-gray-400">No students assigned yet.</p>
        )}
      </div>
    </DashboardShell>
  );
